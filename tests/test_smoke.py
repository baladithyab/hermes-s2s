...
def test_version_is_0_3_1():
    """Guard against version drift: pyproject and __init__ must match this wave's release."""
    import hermes_s2s
    assert hermes_s2s.__version__ == "0.3.1", (
        f"__version__ is {hermes_s2s.__version__!r}; expected '0.3.1'. "
